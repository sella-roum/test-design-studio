...
P0では簡易表示でよいが、TraceLinkを前提としたUI構造にする。
...
| 種類 | 用途 |
|---|---|
| StatusBadge | active / deprecated / removed / draft |
| RiskBadge | high / medium / low |
| ConfidenceBadge | confirmed / assumed / unknown |
| QuestionStatusBadge | open / answered / deferred / blocked |
| AutomationBadge | high / medium / low / unknown |
