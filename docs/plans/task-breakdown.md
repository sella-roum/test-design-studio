...
| TASK-009 | 2 | BusinessRule / TestViewpoint / TestCase | `docs/specs/01-domain-model.md`, `docs/specs/08-test-design-workbench.md` | `tasks/phase-2-domain.md` |
| TASK-010 | 2 | TraceLink / ChangeRecord | `docs/specs/06-traceability-spec.md`, `docs/specs/07-change-management-spec.md` | `tasks/phase-2-domain.md` |
...
| TASK-016 | 3 | TestViewpoint / TestCase編集UI | `docs/specs/01-domain-model.md`, `docs/specs/03-web-app-spec.md`, `docs/specs/08-test-design-workbench.md` | `tasks/phase-3-web.md` |
