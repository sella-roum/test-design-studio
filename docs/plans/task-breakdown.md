...
| TASK-002  | Foundation | Reactアプリ基盤作成                                | `docs/specs/00-product-overview.md`                                                                                                             | `tasks/phase-0-1.md`              |
| TASK-003  | Foundation | 品質ゲート追加                                     | `docs/agents/coding-instructions.md`                                                                                                            | `tasks/phase-0-1.md`              |
| TASK-004  | Foundation | Dexie初期化                                        | `docs/specs/02-storage-design.md`                                                                                                               | `tasks/phase-0-1.md`              |
| TASK-005  | Foundation | ProjectモデルとRepository                          | `docs/specs/01-domain-model.md`, `docs/specs/02-storage-design.md`                                                                              | `tasks/phase-2-domain.md`         |
| TASK-006  | Foundation | Feature / ScreenモデルとRepository                 | `docs/specs/01-domain-model.md`, `docs/specs/02-storage-design.md`                                                                              | `tasks/phase-2-domain.md`         |
| TASK-007  | Foundation | UiNodeモデルとRepository                           | `docs/specs/01-domain-model.md`, `docs/specs/02-storage-design.md`                                                                              | `tasks/phase-2-domain.md`         |
| TASK-008  | Foundation | DataType / EntityモデルとRepository                | `docs/specs/01-domain-model.md`, `docs/specs/02-storage-design.md`                                                                              | `tasks/phase-2-domain.md`         |
| TASK-009  | Foundation | BusinessRule / TestViewpoint / TestCase / TestStep | `docs/specs/01-domain-model.md`, `docs/specs/08-test-design-workbench.md`                                                                       | `tasks/phase-2-domain.md`         |
| TASK-010  | Foundation | OpenQuestion / TraceLink / ChangeRecord            | `docs/specs/01-domain-model.md`, `docs/specs/06-traceability-spec.md`, `docs/specs/07-change-management-spec.md`                                | `tasks/phase-2-domain.md`         |
| TASK-010A | Foundation | Reserved model hooks                               | `docs/specs/01-domain-model.md`, `docs/specs/02-storage-design.md`, `docs/specs/05-import-export-spec.md`                                       | `tasks/phase-2-domain.md`         |
...
Foundation Phase (TASK-002～TASK-010A) はまとめて実装する。このフェーズは後続すべてのPhaseが依存する最小基盤であり、1PRで完了させる。
...
| Foundation | アプリ基盤・品質ゲート・IndexedDB保存層・全ドメインモデル・Repositoryを確立する |
