...
Phase 3では、Webアプリ単体で1機能分の仕様把握、UI構造、データ条件、業務ルール、テスト観点、テストケースを手入力できる状態を作る。
...
- セクションナビゲーションを追加する。
- Overview / Screens / UI Tree / Data / Rules / Viewpoints / Test Cases の枠を追加する。
...
## TASK-016: TestViewpoint / TestCase編集UI
...
- priority / automationSuitabilityなどの基本属性を扱う。
...
- priority / automationSuitabilityを保存できる。
